...
const pagination = document.querySelector('.container__left__pagination');
const editorForm = document.querySelector('.editor__form');
const closeBtn = document.querySelector('.editor__cancel-btn');
...
const createPages = () => {
  ...
  for (let page of pages) {
    ...
    el.className = 'container__left__pagination__btn';
 ...
 */
document.querySelector('.container__left__pagination')
...
/**
 * При нажатии на 'отмена' скрывает форму
 */
closeBtn.onclick = () => {
 ...
 */
document.querySelector('.editor__save-btn')
  .addEventListener('click', evt => {
    evt.preventDefault();
 ...
 */
const hideColumn = () => {
  const hiddenBtns = document.querySelectorAll('.container__left__buttons__btn-hide');
